...
import { GetWaitlistEntryByIdServiceInterface } from '../interfaces/get-waitlist-entry-by-id-service.interface';

@Injectable()
export class GetWaitlistEntryByIdService implements GetWaitlistEntryByIdServiceInterface {
  constructor(
